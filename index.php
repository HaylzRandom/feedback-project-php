...
if (isset($_POST['submit'])) {
	...
	if (empty($nameErr) && empty($emailErr) && empty($bodyErr)) {
		...
		echo "<span class='border border-success rounded text-success text-center text-wrap fs-2 fw-bold w-75 p-3'>Thanks for the submission $name! Your feedback means a lot to us!</span>";
	}
}
...
<h2>Feedback</h2>
<p class="lead text-center">Leave feedback for Angel Farm Shop</p>
